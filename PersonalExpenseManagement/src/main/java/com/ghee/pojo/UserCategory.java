...
@NamedQueries({
    ...
    @NamedQuery(name = "UserCategory.findById", query = "SELECT u FROM UserCategory u WHERE u.id = :id")})
public class UserCategory implements Serializable {
    ...
    public UserCategory(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "com.ghee.pojo.UserCategory[ id=" + id + " ]";
    }
